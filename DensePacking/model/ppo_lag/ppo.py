...
from model.ppo_lag.net import DeepNetwork
from model.ppo_lag.memorybuffer import Buffer
        ...
        for _ in range(epochs):
            ...
            for t in range(steps_per_epoch):
                ...
                if d or steps == ep_len:
                    ...
                    cos = self.env.cost()
                    #if(cos["cost"]==0.):
                    #    filename = f'{self.env.packing.fraction:.3f} {cos["cost"]}.scr'
                    #    scr(filename, self.env.packing.visable_particles, self.env.agent)
